...
- Direção atual: antes de retomar a fase 2 privada, executar um experimento público com Pagila/Sakila para validar contexto de schema e runtime. A seleção e seus limites estão em `docs/research/public-descriptive-databases.md`. O conjunto público de 512 schemas continuará imutável como benchmark de regressão. O modelo-base está no cache local e a revisão foi fixada em `768f209d9ea81521153ed38c47d515654e938aea`.
